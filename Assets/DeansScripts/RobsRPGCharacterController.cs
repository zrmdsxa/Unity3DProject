...
public class RPGCharacterController : MonoBehaviour {
	...
	public Collider Weapons_hitbox;
	...
	void Update() {
		...
		AnimatorStateInfo currentUpperTorosoState = m_animationController.GetCurrentAnimatorStateInfo(1);
		if(currentUpperTorosoState.fullPathHash == m_attackState){
			Weapons_hitbox.enabled = true;
